...
public:
    ...
    )
    {
        ...
        if (m_runners[0].size() == lastSize) {
            m_runners[0].push(::std::make_unique<::xrn::pool::Job<LambdaType>>(::std::move(lambda)));
            ...
            for (
                ...
                if (runner.size() == lastSize) {
                    runner.push(::std::make_unique<::xrn::pool::Job<LambdaType>>(::std::move(lambda)));
                    break;
                }
            }
        } else {
...
private:
    ...
    ::std::vector<::xrn::pool::Runner> m_runners;
